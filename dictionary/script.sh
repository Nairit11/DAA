...
plot '~/dictionary/best.txt' title 'Best' with linespoints ls 1, '~/dictionary/worst.txt' title 'Worst' with linespoints ls 2, '~/dictionary/average.txt' title 'Average' with linespoints ls 4;
pause -1"
